...
* **i18n:** the reading pass — plurals, the map's figure, and the horizon said as what it is ([7548085](https://github.com/misterhonk/fidelity/commit/7548085b99637183273bbe5f2abb82fc8c3d7123))
...
* **dig:** two visits side by side — new, gone, still there ([0d7300a](https://github.com/misterhonk/fidelity/commit/0d7300ac5a93aa078961b09f3badd33617b547b2))
...
* **dig:** a quiet check-in from before M36 reads as a quiet look ([8a93d69](https://github.com/misterhonk/fidelity/commit/8a93d690e5433b4f88f5d64de224393bcebf2158))
...
* **dig:** the history as the shops' story — visits, quiet check-ins, what left ([6a557d5](https://github.com/misterhonk/fidelity/commit/6a557d554c35f576244642269a5d9069199f9242))
...
* **basket:** how much more fits at this postage, and how fast a shop's finds go ([d1b6e56](https://github.com/misterhonk/fidelity/commit/d1b6e56384be0d44667af88d9d6e0133e22881e8))
...
* **pwa:** the policy lets the audio preview load its player, and the consent stands where the clips are ([57b6cf0](https://github.com/misterhonk/fidelity/commit/57b6cf004c9ebaec726f1dbbb6e89f06d3afd9ed))
...
* **hub:** the catalogue answers how many discs a release is ([d755a88](https://github.com/misterhonk/fidelity/commit/d755a88b7a8ecc44db6661d0ca07699cdd5e73bc))
...
* **basket:** the parser reads the whole shop text, and the table adds up in your currency ([5f3ffdd](https://github.com/misterhonk/fidelity/commit/5f3ffdd30f5b9ebff0351d67973c1dff77484012))
...
* **i18n:** the start, the reasons and the dig speak from behind the counter ([a877d1d](https://github.com/misterhonk/fidelity/commit/a877d1d82130326b16d3d716aeee0f6e5b3735d1))
...
* **i18n:** the voice, with the welcome and the shops in it ([7e9d459](https://github.com/misterhonk/fidelity/commit/7e9d459659e6d2eafc90b524ecf5606c3b2a9912))
...
* **dealers:** one call, two indexes, four components ([c8d9aa7](https://github.com/misterhonk/fidelity/commit/c8d9aa76785bc299229f12317124adb84a7dd293))
...
* **basket:** postage as Discogs names it, one listing at a time ([091a5d0](https://github.com/misterhonk/fidelity/commit/091a5d047f1bb8e536a525b58e2ad256e4ab8c01))
...
* **dealers:** the masthead and the plates ([aaab4ef](https://github.com/misterhonk/fidelity/commit/aaab4ef1ce3a849d9a794de7d753013732bacef5))
...
* **hub:** a shop's path is a username, a reading cannot come from the future, the secret door has a ceiling ([0738d51](https://github.com/misterhonk/fidelity/commit/0738d51680d581ade8af765e9c0bf3819ab2cdf0))
* **pwa:** a Content-Security-Policy computed from the build, and the hub's answers held to bounds ([08579f3](https://github.com/misterhonk/fidelity/commit/08579f36a949c8a21faae7a41c94fd5dbeb6ed47))
...
* **dig:** the compact density gets its column names back ([a17a500](https://github.com/misterhonk/fidelity/commit/a17a500a585ee38ab70a1f22c2b5382f512e78ee))
...
* **dig:** j and k walk the list, / jumps into the filter ([619f363](https://github.com/misterhonk/fidelity/commit/619f363696753855ec2977adfe9639859103ce22))
...
* **dealers:** on a phone the open shop is a sheet ([00d61c5](https://github.com/misterhonk/fidelity/commit/00d61c511ed9eb0df272c30b4d58e55116a0bb5f))
...
* **collection:** the shelf's sync line is a plate (M28 [#7](https://github.com/misterhonk/fidelity/issues/7)) ([820144d](https://github.com/misterhonk/fidelity/commit/820144d7c7e10093b4077a078ba81242523908dc))
...
* **collection:** the wantlist as sleeves, one per album (M28 [#1](https://github.com/misterhonk/fidelity/issues/1) [#2](https://github.com/misterhonk/fidelity/issues/2)) ([8c3a030](https://github.com/misterhonk/fidelity/commit/8c3a0307359f46c25609425046bf2a3c43a7a304))
