...
| M35.3 The rest | Basket, Collection, Wantlist, Places, Settings, errors — both languages | Basket and Collection (shelf, map, wantlist, places, watched, saved) in `v0.97.0`, 2026-09-17; Settings and the common pack (errors, watch, listen, install) next |
