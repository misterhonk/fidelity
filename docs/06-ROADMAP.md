...
| M35.3 The rest | Basket, Collection, Wantlist, Places, Settings, errors — both languages | Basket and Collection in `v0.97.0`; the common pack (errors, notices, token, next steps, in-store, demo, watch, the push notice) in `v0.98.0`, 2026-09-17; Settings next |
